...
**Use case:** Fetch current dashboard data on-demand (e.g., initial page load)
...
```javascript
// Get personal mode data
fetch('http://localhost:3006/api/dashboard/data?mode=personal')
  .then(res => res.json())
  .then(data => console.log(data.data));

// Get guest mode data (public only)
fetch('http://localhost:3006/api/dashboard/data?mode=guest')
  .then(res => res.json())
  .then(data => console.log(data.data));

// Get briefing mode (condensed summary)
fetch('http://localhost:3006/api/dashboard/data?mode=briefing')
  .then(res => res.json())
  .then(data => console.log(data.data));
```
